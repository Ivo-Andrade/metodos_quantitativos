...
print( len( conjuntoIdDeInstituicoesBarradasPorFiltros ) )
...
#   Obtencao da lista de IDs de subdisciplinas

conjuntoDeIDsDeInstituicoes = set()
conjuntoDeIDsDeSubdisciplinas = set()
...
with open(filepath, 'r', encoding='utf8') as file:
    ...
    for entrada in listaQuantidadePublicacoes_filtrado :
        if entrada["ID_da_instituicao"] not in conjuntoDeIDsDeInstituicoes :
            ...
            conjuntoDeIDsDeSubdisciplinas.add( entrada["ID_da_subdisciplina"] )
...
#   Filtragem da lista de subdisciplinas
...
with open(filepath, 'r', encoding='utf8') as file:
    ...
    for subdisciplina in listaSubdisciplinas :
        if subdisciplina["ID_da_subdisciplina"] in conjuntoDeIDsDeSubdisciplinas:
            entradaFiltrada.append( subdisciplina )

filepath = path.abspath( path.join(pathBase, "..", "dados", "filtrados", "Subdisciplinas_filtrado.tsv"))
f = open(filepath, "w")
f.write("ID_da_subdisciplina\tNome_da_subdisciplina\tID_da_disciplina\n")

for item in entradaFiltrada:
    f.write(
        "{}\t{}\t{}\n".format(
            item["ID_da_subdisciplina"], 
            item["Nome_da_subdisciplina"], 
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "filtrados", "mesorregioes", "PIBdeMesorregioes_filtrado.tsv") )
f = open(filepath, "w")
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "filtrados", "estados", "PIBdeEstados_filtrado.tsv") )
f = open(filepath, "w")
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "filtrados", "estados", "ESTABELECIMENTOS_ESTADOS_2010_FILTRADO.tsv"))
f = open(filepath, "w")
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "filtrados", "estados", "ESTABELECIMENTOS_ESTADOS_2011_FILTRADO.tsv"))
f = open(filepath, "w")
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "filtrados", "estados", "ESTABELECIMENTOS_ESTADOS_2012_FILTRADO.tsv"))
f = open(filepath, "w")
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "filtrados", "estados", "ESTABELECIMENTOS_ESTADOS_2013_FILTRADO.tsv"))
f = open(filepath, "w")
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "filtrados", "estados", "ESTABELECIMENTOS_ESTADOS_2014_FILTRADO.tsv"))
f = open(filepath, "w")
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "filtrados", "estados", "ESTABELECIMENTOS_ESTADOS_2015_FILTRADO.tsv"))
f = open(filepath, "w")
