...
filepath = path.abspath( path.join(pathBase, "..", "dados", "1_compatibilidade_de_dados") )
...
for dadosEstabelecimentos2015 in listaEstabelecimentos2015 :
    ...
    print( "Progresso: {}/{}".format( i, len(listaEstabelecimentos2015) ) )
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "1_compatibilidade_de_dados", "municipios.csv") )
with open(filepath, 'w+', newline='') as csvFile:
    writer = DictWriter(csvFile, fieldnames=indices)
    writer.writeheader()
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "0_iniciais",  "Instituicoes.txt"))
with open(filepath, 'r', encoding='utf8') as file:
    dictReader = DictReader(file, delimiter='\t')

    filepath2 = path.abspath( path.join(pathBase, "..", "dados", "1_compatibilidade_de_dados",  "Instituicoes_alterado.tsv"))
