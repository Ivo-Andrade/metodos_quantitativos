...
##
#
#   Agrupamento da producao academica por ano, instituicao e disciplina
#
##

##
#   Agrupamento por ano, instituicao e sub-disciplina
##
...
dictContadorPublicacoesPorSubdisciplina = OrderedDict()
...
for publicacao in listaDadosDePublicacoes :
    ...
    if ( idDeInstituicao, idDaSubdisciplina, anoPublicacao ) not in dictContadorPublicacoesPorSubdisciplina :
        dictContadorPublicacoesPorSubdisciplina[( idDeInstituicao, idDaSubdisciplina, anoPublicacao )] = 1
    else:
        dictContadorPublicacoesPorSubdisciplina[( idDeInstituicao, idDaSubdisciplina, anoPublicacao )] += 1

##
#   Agrupamento por ano, instituicao e disciplina
##
...
dictContadorPublicacoesPorDisciplina = OrderedDict()

for chave in dictContadorPublicacoesPorSubdisciplina.keys() :
    ( idDeInstituicao, idDaSubdisciplina, anoPublicacao ) = chave

    idDaDisciplina = -1

    for subdisciplina in listaSubdisciplinas :
        if subdisciplina["ID_da_subdisciplina"] == idDaSubdisciplina :
            idDaDisciplina = subdisciplina["ID_da_disciplina"]

    if ( idDeInstituicao, idDaDisciplina, anoPublicacao ) not in dictContadorPublicacoesPorDisciplina :
        dictContadorPublicacoesPorDisciplina[( idDeInstituicao, idDaDisciplina, anoPublicacao )] = 1
    else:
        dictContadorPublicacoesPorDisciplina[( idDeInstituicao, idDaDisciplina, anoPublicacao )] += 1

filepath = path.abspath( path.join(pathBase, "..", "dados", "2_agregacao_de_dados") )
...
for chave in dictContadorPublicacoesPorDisciplina:
    idDeInstituicao, idDaDisciplina, anoPublicacao = chave
    f.write(
        "{}\t{}\t{}\t{}\n".format(
            idDeInstituicao, idDaDisciplina, anoPublicacao, dictContadorPublicacoesPorDisciplina[chave]
        )
    )
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "2_agregacao_de_dados", "microrregioes") )
if not os.path.exists(filepath):
    os.makedirs(filepath)
...
with open(filepath, 'r', encoding='utf8') as file:
    ...
    filepath = path.abspath( path.join(pathBase, "..", "dados", "1_compatibilidade_de_dados", "RAIS_N_ESTABELECIMENTOS_2010_ALTERADO.csv"))
    with open(filepath, 'r', encoding='utf8') as file:
        dictReader = DictReader(file)
...
with open(filepath, 'r', encoding='utf8') as file:
    ...
    filepath = path.abspath( path.join(pathBase, "..", "dados", "1_compatibilidade_de_dados", "RAIS_N_ESTABELECIMENTOS_2011_ALTERADO.csv"))
    with open(filepath, 'r', encoding='utf8') as file:
        dictReader = DictReader(file)
...
with open(filepath, 'r', encoding='utf8') as file:
    ...
    filepath = path.abspath( path.join(pathBase, "..", "dados", "1_compatibilidade_de_dados", "RAIS_N_ESTABELECIMENTOS_2012_ALTERADO.csv"))
    with open(filepath, 'r', encoding='utf8') as file:
        dictReader = DictReader(file)
...
with open(filepath, 'r', encoding='utf8') as file:
    ...
    filepath = path.abspath( path.join(pathBase, "..", "dados", "1_compatibilidade_de_dados", "RAIS_N_ESTABELECIMENTOS_2013_ALTERADO.csv"))
    with open(filepath, 'r', encoding='utf8') as file:
        dictReader = DictReader(file)
...
with open(filepath, 'r', encoding='utf8') as file:
    ...
    filepath = path.abspath( path.join(pathBase, "..", "dados", "1_compatibilidade_de_dados", "RAIS_N_ESTABELECIMENTOS_2014_ALTERADO.csv"))
    with open(filepath, 'r', encoding='utf8') as file:
        dictReader = DictReader(file)
...
with open(filepath, 'r', encoding='utf8') as file:
    ...
    filepath = path.abspath( path.join(pathBase, "..", "dados", "1_compatibilidade_de_dados", "RAIS_N_ESTABELECIMENTOS_2015_ALTERADO.csv"))
    with open(filepath, 'r', encoding='utf8') as file:
        dictReader = DictReader(file)
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "2_agregacao_de_dados", "mesorregioes") )
if not os.path.exists(filepath):
    os.makedirs(filepath)
...
filepath = path.abspath( path.join(pathBase, "..", "dados", "2_agregacao_de_dados", "estados") )
if not os.path.exists(filepath):
    os.makedirs(filepath)
